...
// ***********************************************************************
// <copyright file="HelpRequestedParseResultFactory.cs" company="ArgParser.Styles.Extensions">
...
namespace ArgParser.Styles.Extensions
{
    ...
    public class HelpRequestedParseResultFactory : IParseResultFactory
    {
        ...
        public virtual IParseResult Create(Dictionary<object, Parser> results,
            IEnumerable<ParseException> parseExceptions)
        {
